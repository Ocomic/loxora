...
- A combined Guided temporal surface uses the existing read APIs and requires a revalidated presentation receipt before Context becomes the active step.
...
Home includes a short, explicitly non-implemented concept preview showing how the same model can preserve novel canon, prior drafts, planned plot changes, and affected chapters. A real novel fixture remains outside Milestone 6.2.
